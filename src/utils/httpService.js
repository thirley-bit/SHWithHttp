...
const request = async (method, url, params) => {
  ...
  const option = {
    ...
    header: {
      ...
      "token":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyZWFsTmFtZSI6IiIsInRlbGVwaG9uZSI6IjEyMyIsInVzZXJUeXBlIjoxLCJ1c2VyTmFtZSI6IueUqOaItzEyMyIsInJhbmRvbURhdGUiOjE2OTU2NDQ0MDQ5MTYsInVzZXJJZCI6IjNlZTgzYjg1NzNiNTRmNWM5OTI4ODYxODAzOWI3Yzg0In0.BuNYITYzp3qNP8-XiaT4yXFnxTHTaMHTj_jh7R-WLCc"
     },
    success(res) {
      Taro.hideLoading()
      //如果返回错误，原因

...
const request = async (method, url, params) => {
  ...
  const option = {
    ...
    header: {
      ...
      "token":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyZWFsTmFtZSI6IiIsInRlbGVwaG9uZSI6IjEyMyIsInVzZXJUeXBlIjoxLCJ1c2VyTmFtZSI6IueUqOaItzEyMyIsInJhbmRvbURhdGUiOjE2OTU2OTAzMTkzNjcsInVzZXJJZCI6IjNlZTgzYjg1NzNiNTRmNWM5OTI4ODYxODAzOWI3Yzg0In0.dsQoH_62ZCu2ltKBqD06G9KCPkWhfIExmUB8jnv86Gs"
     },
    success(res) {
      Taro.hideLoading()
      //如果返回错误，原因
